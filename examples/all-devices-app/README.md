...
PROGRAM OPTIONS
  ...
  --device <ambient-sensing-union|chime|contact-sensor|dimmable-light|fan|fan-no-onoff|flow-sensor|humidity-sensor|light-sensor|occupancy-sensor|on-off-light|power-source|pressure-sensor|rain-sensor|soil-sensor|speaker|water-freeze-detector|water-leak-detector>
