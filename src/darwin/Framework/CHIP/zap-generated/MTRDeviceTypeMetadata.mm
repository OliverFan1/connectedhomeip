...
static /* constexpr */ const MTRDeviceTypeData knownDeviceTypes[] = {
    ...
    { 0x00000130, MTRDeviceTypeClass::Utility, @"Joint Fabric Administrator" },
    { 0x00000140, MTRDeviceTypeClass::Simple, @"Intercom" },
    { 0x00000141, MTRDeviceTypeClass::Simple, @"Audio Doorbell" },
    { 0x00000142, MTRDeviceTypeClass::Simple, @"Camera" },
    { 0x00000143, MTRDeviceTypeClass::Simple, @"Video Doorbell" },
    { 0x00000144, MTRDeviceTypeClass::Simple, @"Floodlight Camera" },
    { 0x00000145, MTRDeviceTypeClass::Simple, @"Snapshot Camera" },
    ...
    { 0x00000151, MTRDeviceTypeClass::Simple, @"Ambient Sensing Union" },
